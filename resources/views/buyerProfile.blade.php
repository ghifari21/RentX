        ...
        <div class="row">
            ...
            <div class="col-3 p-3">
                ...
                <div class="row mb-3 border-bottom border-secondary">
                    ...
                    <div class="col">
                        <a href="/buyerProfile" class="text-black" style="text-decoration: none;"><p>Kos Saya</p></a>
                    </div>
                </div>
                <div class="row mb-3 border-bottom border-secondary">
                    <div class="col-1">
                    ...
                    <div class="col">
                        <a href="/buyerHistory" class="text-black" style="text-decoration: none;"><p>Riwayat Kos</p></a>
                    </div>
                </div>
                <div class="row mb-3 border-bottom border-secondary">
                    <div class="col-1">
                    ...
                    <div class="col">
                        <a href="/buyerVerification" class="text-black" style="text-decoration: none;"><p>Verifikasi Akun</p></a>
                    </div>
                </div>
            </div>
            ...
            <!-- right side section -->
            <div class="col p-3">
                <h1 class="fs-3 fw-bold mb-3">Kos Saya</h1>
