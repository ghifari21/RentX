    ...
    <div class="container">
        ...
        <div class="row mt-2">
            ...
            <div class="gallery-container col-md">
                ...
                <div class="column">
                    <img class="demo cursor" src="{{ $property->photo_1 }}" style="width:100%" onclick="currentSlide(1)" alt="">
                </div>
                <div class="column">
                    <img class="demo cursor" src="{{ $property->photo_2 }}" style="width:100%" onclick="currentSlide(2)" alt="">
                </div>
                <div class="column">
                    <img class="demo cursor" src="{{ $property->photo_3 }}" style="width:100%" onclick="currentSlide(3)" alt="">
                </div>
                <div class="column">
                    <img class="demo cursor" src="{{ $property->photo_4 }}" style="width:100%" onclick="currentSlide(4)" alt="">
                </div>
                <div class="column">
                    <img class="demo cursor" src="{{ $property->photo_5 }}" style="width:100%" onclick="currentSlide(5)" alt="">
                </div>
                </div>
            </div>
        ...
        <div class="row mt-4">
            <div class="container detail-container">
                ...
                <div class="row">
                    ...
                    <div class="col-md">
                        <iframe src="{{ $property->link_location }}" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </div>
